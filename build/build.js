System.registerDynamic("github:knockout/knockout@3.3.0/dist/knockout.debug", [], false, function(__require, __exports, __module) {
...
System.registerDynamic("github:knockout/knockout@3.3.0", ["github:knockout/knockout@3.3.0/dist/knockout.debug"], true, function(require, exports, module) {
  ;
  var global = this,
...
System.registerDynamic("npm:core-js@1.2.1/library/fn/object/define-property", ["npm:core-js@1.2.1/library/modules/$"], true, function(require, exports, module) {
  ;
  var global = this,
      __define = global.define;
  global.define = undefined;
...
System.registerDynamic("npm:babel-runtime@5.8.25/core-js/object/define-property", ["npm:core-js@1.2.1/library/fn/object/define-property"], true, function(require, exports, module) {
  ;
  var global = this,
      __define = global.define;
  global.define = undefined;
...
System.registerDynamic("npm:core-js@1.2.1/library/modules/$.microtask", ["npm:core-js@1.2.1/library/modules/$.global", "npm:core-js@1.2.1/library/modules/$.task", "npm:core-js@1.2.1/library/modules/$.cof", "github:jspm/nodelibs-process@0.1.2"], true, function(require, exports, module) {
  ;
  var global = this,
      __define = global.define;
  global.define = undefined;
...
System.registerDynamic("npm:core-js@1.2.1/library/modules/es6.promise", ["npm:core-js@1.2.1/library/modules/$", "npm:core-js@1.2.1/library/modules/$.library", "npm:core-js@1.2.1/library/modules/$.global", "npm:core-js@1.2.1/library/modules/$.ctx", "npm:core-js@1.2.1/library/modules/$.classof", "npm:core-js@1.2.1/library/modules/$.def", "npm:core-js@1.2.1/library/modules/$.is-object", "npm:core-js@1.2.1/library/modules/$.an-object", "npm:core-js@1.2.1/library/modules/$.a-function", "npm:core-js@1.2.1/library/modules/$.strict-new", "npm:core-js@1.2.1/library/modules/$.for-of", "npm:core-js@1.2.1/library/modules/$.set-proto", "npm:core-js@1.2.1/library/modules/$.same", "npm:core-js@1.2.1/library/modules/$.species", "npm:core-js@1.2.1/library/modules/$.wks", "npm:core-js@1.2.1/library/modules/$.uid", "npm:core-js@1.2.1/library/modules/$.microtask", "npm:core-js@1.2.1/library/modules/$.support-desc", "npm:core-js@1.2.1/library/modules/$.mix", "npm:core-js@1.2.1/library/modules/$.tag", "npm:core-js@1.2.1/library/modules/$.core", "npm:core-js@1.2.1/library/modules/$.iter-detect", "github:jspm/nodelibs-process@0.1.2"], true, function(require, exports, module) {
  ;
  var global = this,
      __define = global.define;
  global.define = undefined;
...
System.register("app/kohash/kohash.js", ["npm:babel-runtime@5.8.25/helpers/create-class", "npm:babel-runtime@5.8.25/helpers/class-call-check", "npm:babel-runtime@5.8.25/core-js/promise"], function (_export) {
    var _createClass, _classCallCheck, _Promise, KOHash;
    ...
    return {
        ...
        execute: function () {
            ...
            KOHash = (function () {
                function KOHash() {
                    var _viewConvention = arguments.length <= 0 || arguments[0] === undefined ? "/views/{location}View.htm" : arguments[0];

                    var _viewModelConvention = arguments.length <= 1 || arguments[1] === undefined ? "/viewmodels/{location}ViewModel.js" : arguments[1];

                    _classCallCheck(this, KOHash);
                ...
                _createClass(KOHash, [{
                    key: "Load",
                    value: function Load(hash, location, key, element) {
                        var viewPath = location + this._viewConvention.replace("{location}", key);
                        var viewModelPath = location + this._viewModelConvention.replace("{location}", key);
                        element.hidden = true;
                        var textPromise = window.fetch(viewPath).then(function (rsp) {
                            return rsp.text();
                        });
                        var vmPromise = System["import"](viewModelPath).then(function (mod) {
                            return mod["default"];
                        });
                        _Promise.all([textPromise, vmPromise]).then(function (res) {
            ...
            _export("default", KOHash);
        }
    };
});
System.register("app/main.js", ["github:knockout/knockout@3.3.0", "app/kohash/kohash.js"], function (_export) {
  "use strict";

  var ko, kohash, handler, elemm;
  return {
    setters: [function (_githubKnockoutKnockout330) {
      ko = _githubKnockoutKnockout330;
    }, function (_appKohashKohashJs) {
      kohash = _appKohashKohashJs["default"];
    }],
    execute: function () {
      ko.observable(3);
      handler = new kohash();
      elemm = document.getElementById("page1");
